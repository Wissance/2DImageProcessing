...
CONFIG.NUM_SI {2} \
  ...
  # Create instance: dragster_configurator_0, and set properties
  set block_name dragster_configurator
  set block_cell_name dragster_configurator_0
  if { [catch {set dragster_configurator_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $dragster_configurator_0 eq "" } {
...
CONFIG.IN1_WIDTH {1} \
  ...
  connect_bd_net -net dragster_configurator_0_ss_n [get_bd_ports LINESCANNER_CS] [get_bd_pins dragster_configurator_0/ss_n]
...
HDL_ATTRIBUTE.MARK_DEBUG {true} \
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs image_capture_manager_0/s00_axi/reg0] SEG_image_capture_manager_0_reg1
...
preplace netloc image_capture_manager_0_reset 1 4 1 1150
preplace netloc linescanner_image_capture_unit_1_main_clock 1 0 2 NJ -370 -280
preplace netloc linescanner_image_capture_unit_1_sample 1 0 2 NJ -130 -290
preplace netloc linescanner_image_capture_unit_1_rst_cds 1 0 2 NJ -360 -300
preplace netloc LINESCANNER1_LVAL_1 1 0 1 -670
preplace netloc linescanner_image_capture_unit_0_rst_cds 1 0 2 NJ -730 -300
preplace netloc linescanner_image_capture_unit_0_rst_cvc 1 0 2 NJ -760 -290
preplace netloc image_capture_manager_0_image_capture_enabled 1 0 5 -640 -780 NJ -800 NJ -800 N -800 1110
preplace netloc dragster_configurator_0_sclk 1 5 2 N -100 NJ
preplace netloc image_capture_manager_0_clear_memory 1 2 3 60 -40 NJ -90 1100
preplace netloc LINESCANNER1_END_ADC_1 1 0 1 -680
preplace netloc frequency_analyzer_manager_1_irq 1 3 1 NJ
preplace netloc processing_system7_0_M_AXI_GP0 1 3 3 NJ -830 NJ -830 1630
preplace netloc LINESCANNER_MISO_1 1 4 3 1180 -30 NJ -110 N
preplace netloc axi_interconnect_0_M02_AXI 1 2 3 10 -820 NJ -820 1130
preplace netloc linescanner_image_capture_unit_0_load_pulse 1 0 2 NJ -790 -260
preplace netloc linescanner_image_capture_unit_0_main_clock 1 0 2 NJ -770 -270
preplace netloc frequency_analyzer_manager_0_irq 1 3 1 NJ
preplace netloc processing_system7_0_FCLK_RESET0_N 1 4 2 1180 -490 1610
preplace netloc LINESCANNER1_PIXEL_CLOCK_1 1 0 1 -720
preplace netloc linescanner_image_capture_unit_0_sample 1 0 2 NJ -750 -280
preplace netloc axi_interconnect_0_M04_AXI 1 4 1 1140
...
preplace netloc frequency_analyzer_synch_0_start_analyzer_0 1 2 1 10
preplace netloc linescanner_image_capture_unit_1_rst_cvc 1 0 2 NJ -120 -270
preplace netloc LINESCANNER0_END_ADC_1 1 0 1 -700
preplace netloc LINESCANNER0_DATA_1 1 0 1 -710
preplace netloc proc_sys_reset_0_peripheral_aresetn 1 0 7 -650 -490 -280 -490 NJ -500 370 -210 NJ -310 1630 -340 1830
preplace netloc axi_interconnect_0_M01_AXI 1 3 2 390 -670 1100
preplace netloc frequency_analyzer_synch_0_start_analyzer_1 1 2 1 30
preplace netloc frequency_analyzer_synch_0_stop_analyzer_0 1 2 1 30
preplace netloc processing_system7_0_FCLK_CLK0 1 1 5 NJ -510 NJ -490 360 -680 1160 -530 1630
preplace netloc processing_system7_0_FCLK_CLK1 1 0 6 -660 -840 NJ -840 NJ -840 NJ -840 NJ -840 1640
preplace netloc dragster_configurator_0_ss_n 1 5 2 N -80 NJ
preplace netloc frequency_analyzer_synch_0_stop_analyzer_1 1 2 1 10
preplace netloc linescanner_image_capture_unit_0_pixel_data 1 1 2 -250 -670 NJ
preplace netloc linescanner_image_capture_unit_1_load_pulse 1 0 2 NJ -140 -300
preplace netloc LINESCANNER1_DATA_1 1 0 1 -690
preplace netloc axi_interconnect_0_M03_AXI 1 2 3 50 -810 NJ -810 1120
preplace netloc processing_system7_0_FCLK_CLK2 1 4 2 1170 -520 1620
...
levelinfo -pg 1 -750 -453 -110 223 931 1393 1723 1850 -top -850 -bot 110
",
}
