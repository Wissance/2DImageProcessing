restart
add_force {/frequency_analyzer_manager_testbench/data} -radix hex {0 200ns} {0xf0 100us} {0xA0 104us} {0xF0 105.1us} -repeat_every 210.4us
...
add_force {/frequency_analyzer_manager_testbench/start} -radix hex {0 100ns} {1 150ns} {0 499us} {1 501us} -repeat_every 501us 
