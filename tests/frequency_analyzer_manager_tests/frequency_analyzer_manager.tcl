restart
add_force {/frequency_analyzer_manager_testbench/data} -radix hex {0 0ns} {0xf0 0.7us} {0x40 0.8us} {0xf0 21.18us} {0x40 21.48us} {0xf0 41.66us} {0x40 41.96us} {0xf0 62.14us} {0x40 62.44us} {0xf0 82.62us} {0x40 82.92us} {0xf0 103.1us} {0x40 103.4us} {0xf0 225.98us} {0x00 226.28us}
...
add_force {/frequency_analyzer_manager_testbench/stop} -radix hex {0 0ns} {1 499us} {0 500us} -repeat_every 501us 
