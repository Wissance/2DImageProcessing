...
add_force {/frequency_analyzer_manager_testbench/clear} -radix hex {0} {1 10ns} {0 5000ms} 
add_force {/frequency_analyzer_manager_testbench/s00_axi_aresetn} -radix hex {1 0ns} {0 5000ms} 