...
unsigned long ps7_clock_init_data_3_0[] = {
    ...
    // ..     ==> MASK : 0x00000030U    VAL : 0x00000000U
    // .. DIVISOR = 0xe
    // .. ==> 0XF8000148[13:8] = 0x0000000EU
    // ..     ==> MASK : 0x00003F00U    VAL : 0x00000E00U
    // .. 
    EMIT_MASKWRITE(0XF8000148, 0x00003F31U ,0x00000E01U),
    // .. CLKACT0 = 0x1
    ...
    // ..     ==> MASK : 0x00000030U    VAL : 0x00000000U
    // .. DIVISOR = 0x1c
    // .. ==> 0XF8000150[13:8] = 0x0000001CU
    // ..     ==> MASK : 0x00003F00U    VAL : 0x00001C00U
    // .. 
    EMIT_MASKWRITE(0XF8000150, 0x00003F33U ,0x00001C01U),
    // .. CLKACT0 = 0x0
    ...
    // .. .. DIVISOR1 = 0x7
    // .. .. ==> 0XF8000190[25:20] = 0x00000007U
    // .. ..     ==> MASK : 0x03F00000U    VAL : 0x00700000U
    // .. .. 
    EMIT_MASKWRITE(0XF8000190, 0x03F03F30U ,0x00700A00U),
    // .. .. CLK_621_TRUE = 0x1
...
unsigned long ps7_ddr_init_data_3_0[] = {
    ...
    // .. .. 
    EMIT_MASKWRITE(0XF8006018, 0xF7FFFFFFU ,0x44E458D1U),
    ...
    // .. .. 
    EMIT_MASKWRITE(0XF800601C, 0xFFFFFFFFU ,0xB2023504U),
    // .. .. reg_ddrc_t_ccd = 0x4
    ...
    // .. .. 
    EMIT_MASKWRITE(0XF8006020, 0x7FDFFFFCU ,0x2708B290U),
    ...
    // .. .. reg_phy_gatelvl_init_ratio = 0xe0
    // .. .. ==> 0XF800612C[19:10] = 0x000000E0U
    // .. ..     ==> MASK : 0x000FFC00U    VAL : 0x00038000U
    // .. .. 
    EMIT_MASKWRITE(0XF800612C, 0x000FFFFFU ,0x00038000U),
    // .. .. reg_phy_wrlvl_init_ratio = 0x0
    ...
    // .. .. 
    EMIT_MASKWRITE(0XF8006130, 0x000FFFFFU ,0x00037C00U),
    // .. .. reg_phy_wrlvl_init_ratio = 0x37
    // .. .. ==> 0XF8006134[9:0] = 0x00000037U
    // .. ..     ==> MASK : 0x000003FFU    VAL : 0x00000037U
    // .. .. reg_phy_gatelvl_init_ratio = 0xa9
    // .. .. ==> 0XF8006134[19:10] = 0x000000A9U
    // .. ..     ==> MASK : 0x000FFC00U    VAL : 0x0002A400U
    // .. .. 
    EMIT_MASKWRITE(0XF8006134, 0x000FFFFFU ,0x0002A437U),
    // .. .. reg_phy_wrlvl_init_ratio = 0x31
    // .. .. ==> 0XF8006138[9:0] = 0x00000031U
    // .. ..     ==> MASK : 0x000003FFU    VAL : 0x00000031U
    // .. .. reg_phy_gatelvl_init_ratio = 0xae
    // .. .. ==> 0XF8006138[19:10] = 0x000000AEU
    // .. ..     ==> MASK : 0x000FFC00U    VAL : 0x0002B800U
    // .. .. 
    EMIT_MASKWRITE(0XF8006138, 0x000FFFFFU ,0x0002B831U),
    ...
    // .. .. reg_phy_wr_dqs_slave_ratio = 0xb7
    // .. .. ==> 0XF800615C[9:0] = 0x000000B7U
    ...
    // .. ..     ==> MASK : 0x000FF800U    VAL : 0x00000000U
    // .. .. 
    EMIT_MASKWRITE(0XF800615C, 0x000FFFFFU ,0x000000B7U),
    // .. .. reg_phy_wr_dqs_slave_ratio = 0xb1
    // .. .. ==> 0XF8006160[9:0] = 0x000000B1U
    // .. ..     ==> MASK : 0x000003FFU    VAL : 0x000000B1U
    // .. .. reg_phy_wr_dqs_slave_force = 0x0
    ...
    // .. ..     ==> MASK : 0x000FF800U    VAL : 0x00000000U
    // .. .. 
    EMIT_MASKWRITE(0XF8006160, 0x000FFFFFU ,0x000000B1U),
    // .. .. reg_phy_fifo_we_slave_ratio = 0x135
    // .. .. ==> 0XF8006168[10:0] = 0x00000135U
    // .. ..     ==> MASK : 0x000007FFU    VAL : 0x00000135U
    ...
    // .. .. 
    EMIT_MASKWRITE(0XF8006168, 0x001FFFFFU ,0x00000135U),
    // .. .. reg_phy_fifo_we_slave_ratio = 0x134
    // .. .. ==> 0XF800616C[10:0] = 0x00000134U
    // .. ..     ==> MASK : 0x000007FFU    VAL : 0x00000134U
    // .. .. reg_phy_fifo_we_in_force = 0x0
    ...
    // .. ..     ==> MASK : 0x001FF000U    VAL : 0x00000000U
    // .. .. 
    EMIT_MASKWRITE(0XF8006170, 0x001FFFFFU ,0x000000FEU),
    // .. .. reg_phy_fifo_we_slave_ratio = 0x103
    // .. .. ==> 0XF8006174[10:0] = 0x00000103U
    // .. ..     ==> MASK : 0x000007FFU    VAL : 0x00000103U
    // .. .. reg_phy_fifo_we_in_force = 0x0
    ...
    // .. ..     ==> MASK : 0x001FF000U    VAL : 0x00000000U
    // .. .. 
    EMIT_MASKWRITE(0XF8006174, 0x001FFFFFU ,0x00000103U),
    ...
    // .. .. reg_phy_wr_data_slave_ratio = 0xf7
    // .. .. ==> 0XF8006184[9:0] = 0x000000F7U
    // .. ..     ==> MASK : 0x000003FFU    VAL : 0x000000F7U
    // .. .. reg_phy_wr_data_slave_force = 0x0
    ...
    // .. ..     ==> MASK : 0x000FF800U    VAL : 0x00000000U
    // .. .. 
    EMIT_MASKWRITE(0XF8006184, 0x000FFFFFU ,0x000000F7U),
    // .. .. reg_phy_wr_data_slave_ratio = 0xf1
    // .. .. ==> 0XF8006188[9:0] = 0x000000F1U
    // .. ..     ==> MASK : 0x000003FFU    VAL : 0x000000F1U
    // .. .. reg_phy_wr_data_slave_force = 0x0
    ...
    // .. ..     ==> MASK : 0x000FF800U    VAL : 0x00000000U
    // .. .. 
    EMIT_MASKWRITE(0XF8006188, 0x000FFFFFU ,0x000000F1U),
    // .. .. reg_phy_bl2 = 0x0
...
unsigned long ps7_mio_init_data_3_0[] = {
    ...
    // ..     ==> MASK : 0x00002000U    VAL : 0x00000000U
    // .. 
    EMIT_MASKWRITE(0XF8000770, 0x00003FFFU ,0x00001680U),
    // .. TRI_ENABLE = 0
    ...
    // ..     ==> MASK : 0x00002000U    VAL : 0x00000000U
    // .. 
    EMIT_MASKWRITE(0XF8000774, 0x00003FFFU ,0x00001680U),
    // .. TRI_ENABLE = 0
    ...
    // ..     ==> MASK : 0x00002000U    VAL : 0x00000000U
    // .. 
    EMIT_MASKWRITE(0XF8000778, 0x00003FFFU ,0x00001680U),
    // .. TRI_ENABLE = 0
    ...
    // ..     ==> MASK : 0x00002000U    VAL : 0x00000000U
    // .. 
    EMIT_MASKWRITE(0XF800077C, 0x00003FFFU ,0x00001680U),
    // .. TRI_ENABLE = 0
    ...
    // ..     ==> MASK : 0x00002000U    VAL : 0x00000000U
    // .. 
    EMIT_MASKWRITE(0XF8000780, 0x00003FFFU ,0x00001680U),
    // .. TRI_ENABLE = 0
    ...
    // ..     ==> MASK : 0x00002000U    VAL : 0x00000000U
    // .. 
    EMIT_MASKWRITE(0XF8000784, 0x00003FFFU ,0x00001680U),
    // .. TRI_ENABLE = 1
    ...
    // ..     ==> MASK : 0x00002000U    VAL : 0x00000000U
    // .. 
    EMIT_MASKWRITE(0XF800078C, 0x00003F01U ,0x00001601U),
    // .. TRI_ENABLE = 0
    ...
    // ..     ==> MASK : 0x00002000U    VAL : 0x00000000U
    // .. 
    EMIT_MASKWRITE(0XF80007A0, 0x00003FFFU ,0x00000700U),
    // .. TRI_ENABLE = 0
    ...
    // ..     ==> MASK : 0x00002000U    VAL : 0x00000000U
    // .. 
    EMIT_MASKWRITE(0XF80007A4, 0x00003FFFU ,0x00000700U),
    // .. TRI_ENABLE = 0
    ...
    // ..     ==> MASK : 0x00002000U    VAL : 0x00000000U
    // .. 
    EMIT_MASKWRITE(0XF80007A8, 0x00003FFFU ,0x00000700U),
    // .. TRI_ENABLE = 0
    ...
    // ..     ==> MASK : 0x00002000U    VAL : 0x00000000U
    // .. 
    EMIT_MASKWRITE(0XF80007AC, 0x00003FFFU ,0x00000700U),
    // .. TRI_ENABLE = 0
    ...
    // ..     ==> MASK : 0x00002000U    VAL : 0x00000000U
    // .. 
    EMIT_MASKWRITE(0XF80007B0, 0x00003FFFU ,0x00000700U),
    // .. TRI_ENABLE = 0
    ...
    // ..     ==> MASK : 0x00002000U    VAL : 0x00000000U
    // .. 
    EMIT_MASKWRITE(0XF80007B4, 0x00003FFFU ,0x00000700U),
    // .. TRI_ENABLE = 0
    ...
    // ..     ==> MASK : 0x00002000U    VAL : 0x00000000U
    // .. 
    EMIT_MASKWRITE(0XF80007D0, 0x00003FFFU ,0x00000600U),
    // .. TRI_ENABLE = 0
    ...
    // .. SDIO0_WP_SEL = 34
    // .. ==> 0XF8000830[5:0] = 0x00000022U
    // ..     ==> MASK : 0x0000003FU    VAL : 0x00000022U
    // .. SDIO0_CD_SEL = 35
    // .. ==> 0XF8000830[21:16] = 0x00000023U
    // ..     ==> MASK : 0x003F0000U    VAL : 0x00230000U
    // .. 
    EMIT_MASKWRITE(0XF8000830, 0x003F003FU ,0x00230022U),
...
unsigned long ps7_peripherals_init_data_3_0[] = {
    ...
    // .. .. 
    EMIT_MASKWRITE(0XE000E014, 0x00FFFFFFU ,0x00124922U),
...
unsigned long ps7_ddr_init_data_2_0[] = {
    ...
    // .. .. 
    EMIT_MASKWRITE(0XF8006020, 0xFFFFFFFCU ,0x2728B290U),
    // .. .. reg_ddrc_en_2t_timing_mode = 0x0
    // .. .. ==> 0XF8006024[0:0] = 0x00000000U
    // .. ..     ==> MASK : 0x00000001U    VAL : 0x00000000U
    // .. .. reg_ddrc_prefer_write = 0x0
